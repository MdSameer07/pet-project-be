...
import (
	...
	gen "example.com/pet-project/gen/proto"
...
func main() {
	...
	err := gen.RegisterMovieSuggestionsServiceHandlerFromEndpoint(context.Background(), mux, "localhost:50059", []grpc.DialOption{grpc.WithInsecure()})
	if err != nil {
		log.Fatal(err)
	}
